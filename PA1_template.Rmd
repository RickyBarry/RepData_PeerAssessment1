...
```
Report: The mean total number of steps taken per day is r meanTotalStepsPerDay and the median total number of steps per day is r medianTotalStepsPerDay.
...
```
Report: The 5-minute interval with the maximium number of steps is r max5MinIntSteps

## Imputing missing values - this spelling with an 'm' was in original template ???
...
```
Report: The total number of missing values is r sumNAs
...
```
Report: The mean total number of steps taken per day is r meanTotalStepsPerDayNAsFilledIn
and the median total number of steps per day is r medianTotalStepsPerDayNAsFilledIn.
